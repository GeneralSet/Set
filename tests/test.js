...
test('#is_set() all diffrent', async t => {
  const s = Set.new(4, 3);
  t.is(s.is_set('0_0_0_0,1_1_1_1,2_2_2_2'), true);
});

test('#is_set() all diffrent but one all same', async t => {
  const s = Set.new(4, 3);
  t.is(s.is_set('0_0_0_1,1_1_1_1,2_2_2_1'), true);
});

test('#is_set() not a set', async t => {
  const s = Set.new(4, 3);
  t.is(s.is_set('0_0_0_1,1_1_1_1,2_2_2_2'), false);
});
...
test('#update_board()', async t => {
  const s = Set.new(4, 3);
  const board = s.update_board(
  ...
  t.is(
    board.get_board(),
    '0_2_1_2,2_2_1_0,1_2_1_1,2_0_1_1,1_1_1_0,2_1_0_1,2_2_0_0,1_2_0_0,1_1_1_2,1_2_0_2,2_2_0_1,0_1_0_0'
  );
});
